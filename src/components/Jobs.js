  ...
  return (//displays each task as a list item
    <div className = 'jobsInfo'>
        <form onSubmit={onSubmitTask}>
            <label htmlFor="taskInput"> <h3>Enter Experience</h3></label> 
            <div></div>
            <input type='text' name='company' value={info.company} onChange = {handleChange} placeholder="Company" id="company-input" />
            <div></div>
            <input type='text' name='role' value={info.role} onChange = {handleChange} placeholder="Role" id="role-input" />
            <div></div>
